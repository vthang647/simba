...
INSERT INTO "sbmaster"."configuration"("application", "profile", "label", "key", "value") VALUES ('sb-gateway-api', 'default', 'default', 'spring.cloud.gateway.routes[1].predicates[0]', 'Path=/sb-product-services/**');
...
INSERT INTO "sbmaster"."configuration"("application", "profile", "label", "key", "value") VALUES ('sb-gateway-api', 'default', 'default', 'spring.cloud.gateway.routes[2].predicates[0]', 'Path=/sb-scheduler-services/**');
...
INSERT INTO "sbmaster"."configuration"("application", "profile", "label", "key", "value") VALUES ('sb-gateway-api', 'default', 'default', 'spring.cloud.gateway.routes[3].predicates[0]', 'Path=/sb-commons-services/**');
